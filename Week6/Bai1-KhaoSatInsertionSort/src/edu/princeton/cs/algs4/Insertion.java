...
public class Insertion {
    ...
    public static void main(String[] args) {
        //In in = new In("C:\\Users\\cattu\\DSA\\algs4-data\\4Kints.txt"); // tạo luồng đọc từ file
        //Integer[] a = in.readAll();  // đọc toàn bộ file vào mảng a
        FileInputStream file = new FileInputStream("C:\\Users\\cattu\\DSA\\algs4-data\\4Kints.txt");
