...
That is, change the next and prev pointers of the nodes so that
the direction of the list is reversed. Return a reference to
...
//class Result {
    ...
    public static DoublyLinkedListNode reverse(DoublyLinkedListNode llist) {
        ...
        DoublyLinkedListNode h = p;
        while (llist.prev != null) {
            llist = llist.prev;
            p.next = new DoublyLinkedListNode(llist.data);
            p = p.next;
        }
        return h;
